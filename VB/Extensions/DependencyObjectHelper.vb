...
Namespace DXGridSample.Extensions
    Public Class DependencyObjectHelper
        ...
        End Sub
        Public Shared ReadOnly DataContextProperty As DependencyProperty = DependencyProperty.RegisterAttached("DataContext", GetType(Object), GetType(DependencyObjectHelper), New PropertyMetadata(Nothing))
    End Class
End Namespace